...
{
  #region Fields
  public readonly static int buttonLimit = 3;
  #endregion
  ...
  public SelectBoxUniversalBuilder(string imageName, Vector2 imagePos, Transform parentTransform, SortedDictionary<string, UnityAction> buttonActions, float scaleRadio = 1.0f)
  {
    ...
    TextBoxBuilder = new TextBoxUniversalBuilder(imageName, parentTransform, imagePos, 2, scaleRadio, false);
  ...
  {
    scaleRadio *= GetScaleRadio(buttonCount);
    Vector2 stdReferenceTextBoxPixel = TextBoxUniversalBuilder.GetReferencePixel(3, 1);
    return  stdReferenceTextBoxPixel * 240f / stdReferenceTextBoxPixel.y;
  }
  #endregion
}
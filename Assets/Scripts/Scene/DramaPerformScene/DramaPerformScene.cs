...
public class DramaPerformScene : MonoBehaviour
{
  ...
  private CharacterUniversalbuilder _characterImage = null;
  #endregion
  ...
  public void Start()
  {
    ...
    // characterImage =================================================================================
    _characterImage = new CharacterUniversalbuilder("001", new(0.5f, 0.5f), _backgroundImage.Transform);
    ...
    _scrollRectGameObejctBuilder.SetContent(_verticalLayoutGroupGameObjectBuilder.RectTransform, "_handleColor");
  }
